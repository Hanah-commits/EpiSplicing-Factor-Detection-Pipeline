...
data <- read.table('0_Files/flanks_meta.bed', header = FALSE, sep = "\t", stringsAsFactors = FALSE)
...
write.table(merged_data, file = "0_Files/flanks_meta.bed", sep = "\t", quote = FALSE, row.names = FALSE)
