...
if __name__ == "__main__":
    ...
    # run rmats
    os.system(f'python {rmats_dir}rmats.py --b1 {output_dir}{tissue1}.txt --b2 {output_dir}{tissue2}.txt --gtf {ref} -t paired --readLength {read_len} --variable-read-length --libType fr-secondstrand --novelSS --nthread 4 --od {output_dir} --tmp {output_dir}tmp/ --task both')
