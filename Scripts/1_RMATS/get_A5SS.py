...
file = '/Users/hanah/EpiSplicing_RMATS/Output/neuro-H1/RMATS/A5SS.MATS.JCEC.txt'
...
for i in range(0,2):
    ...
    df_bed.to_csv(f'0_Files/A5SS_{type[i]}.bed', index=False, sep='\t', header=False)  # input for bedtools intersect
    df.to_csv(f'0_Files/A5SS_exons_{type[i]}.csv', index=False, sep='\t', header=True)
