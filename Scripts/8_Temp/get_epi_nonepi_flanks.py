...
def get_epigenes_pairwise(tool):
    ...
    for hm in hms:
        ...
        # get epigenes
        file_path = glob.glob(f'0_Files/{tool}/{hm}/{hm}_truepos_epigenes.txt')
    ...
    df_epi = pd.read_csv(f'0_Files/{tool}/dPSI_Mval_epi_{prefix}.csv', delimiter='\t')
