...
for file in peaksfiles:
    ...
    peaks.columns = ['seqid',  "flank_start", "flank_stop", "strand", "gene_id", "dPSI", 'peak0', 'peak1', 'summit', 'M_value', 'p_value', 'flanks']
    ...
    peak_dfs.append(flank_peaks_group[['seqid', 'flanks', 'gene_id', 'strand', 'dPSI', hm]])  # 'max_' + hm, '#peaks_'+hm]])
