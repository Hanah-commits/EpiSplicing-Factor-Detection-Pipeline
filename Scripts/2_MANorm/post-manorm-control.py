...
peaksfiles = [hm+'_flanks_control.bed' for hm in hms]
peak_dfs = []

flanks = pd.read_csv('0_Files/filtered_flanks_control.bed', delimiter='\t', header=None)
...
peak_dfs.to_csv('0_Files/Filtered_MValues_control.csv', sep='\t')
