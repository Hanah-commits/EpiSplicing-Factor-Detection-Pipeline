...
if __name__ == "__main__":
    ...
    coeff.to_csv('0_Files/coeff_control.csv', sep='\t')
    coeff = pd.read_csv('0_Files/coeff_control.csv', delimiter='\t')
    ...
    flanks[flanks['gene_id'].isin(epigenes)].to_csv('0_Files/dPSI_Mval_epi_control.csv', sep='\t', index=False)

    # # get flanks of non-epispliced genes
    flanks[flanks['gene_id'].isin(non_epi)].to_csv('0_Files/dPSI_Mval_nonepi_control.csv', sep='\t', index=False)
